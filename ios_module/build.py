...
def compile_js(manifest,config):
	...
	f = os.path.join(cwd,'Classes','JpMasuidriveTiEvernoteapiModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','jp.masuidrive.ti.evernoteapi.js']

...
- (id)createNotesMetadataList:(id)args
{
    ...
    EDAMNotesMetadataList* thrift_object = [[[EDAMNotesMetadataList alloc] init] autorelease];
    JpMasuidriveTiEvernoteapiNotesMetadataListProxy* proxy = [[[JpMasuidriveTiEvernoteapiNotesMetadataListProxy alloc] initWithObject: thrift_object] autorelease];
    if(args) {
        id val;
...
- (NSDictionary*)toHash:(id)args
{
    return [NSDictionary dictionaryWithObjectsAndKeys:
        ...
        arrayMap(object.notes, ^(id item) { return [[[JpMasuidriveTiEvernoteapiNoteMetadataProxy alloc] initWithObject: item] autorelease]; }), @"notes",

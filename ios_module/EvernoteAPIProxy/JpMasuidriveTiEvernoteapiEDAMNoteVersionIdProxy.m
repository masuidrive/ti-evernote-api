...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMNoteVersionIdProxy alloc] initWithObject: [[[EDAMNoteVersionId alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMNoteVersionIdProxy
@synthesize object;

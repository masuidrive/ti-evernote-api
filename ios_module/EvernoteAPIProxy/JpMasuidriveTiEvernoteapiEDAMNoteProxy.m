...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMNoteProxy alloc] initWithObject: [[[EDAMNote alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMNoteProxy
@synthesize object;

...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMNotesMetadataResultSpecProxy alloc] initWithObject: [[[EDAMNotesMetadataResultSpec alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMNotesMetadataResultSpecProxy
@synthesize object;

...
{
    return [[[EDAMNotesMetadataResultSpecProxy alloc] initWithObject: [[[EDAMNotesMetadataResultSpec alloc] init] autorelease]] autorelease];
}
@end


@implementation EDAMNotesMetadataResultSpecProxy
@synthesize object;

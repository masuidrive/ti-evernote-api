...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMSyncChunkFilterProxy alloc] initWithObject: [[[EDAMSyncChunkFilter alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMSyncChunkFilterProxy
@synthesize object;

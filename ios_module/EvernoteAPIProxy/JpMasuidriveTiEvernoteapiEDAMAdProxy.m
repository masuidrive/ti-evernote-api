...
-(id)createAd:(id)args
{
    return [[[JpMasuidriveTiEvernoteapiEDAMAdProxy alloc] initWithObject: [[[EDAMAd alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMAdProxy
@synthesize object;

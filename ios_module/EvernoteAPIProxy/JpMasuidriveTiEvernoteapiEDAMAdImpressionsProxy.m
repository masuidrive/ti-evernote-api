...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMAdImpressionsProxy alloc] initWithObject: [[[EDAMAdImpressions alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMAdImpressionsProxy
@synthesize object;

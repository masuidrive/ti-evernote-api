...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMNoteCollectionCountsProxy alloc] initWithObject: [[[EDAMNoteCollectionCounts alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMNoteCollectionCountsProxy
@synthesize object;

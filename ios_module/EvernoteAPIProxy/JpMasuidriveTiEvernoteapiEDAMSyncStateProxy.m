...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMSyncStateProxy alloc] initWithObject: [[[EDAMSyncState alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMSyncStateProxy
@synthesize object;

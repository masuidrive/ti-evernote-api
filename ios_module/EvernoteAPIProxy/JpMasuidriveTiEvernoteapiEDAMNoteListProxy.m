...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMNoteListProxy alloc] initWithObject: [[[EDAMNoteList alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMNoteListProxy
@synthesize object;

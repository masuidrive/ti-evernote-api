...
#import "JpMasuidriveTiEvernoteapiEDAMUserAttributesProxy.h"
#import "JpMasuidriveTiEvernoteapiEDAMAccountingProxy.h"
...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMUserProxy alloc] initWithObject: [[[EDAMUser alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMUserProxy
@synthesize object;
...
-(id)attributes
{
    return [[[JpMasuidriveTiEvernoteapiEDAMUserAttributesProxy alloc] initWithObject: object.attributes] autorelease];
}

-(void)setAttributes:(id)value
{
    object.attributes = ((JpMasuidriveTiEvernoteapiEDAMUserAttributesProxy*)value).object;
}


-(id)accounting
{
    return [[[JpMasuidriveTiEvernoteapiEDAMAccountingProxy alloc] initWithObject: object.accounting] autorelease];
}

-(void)setAccounting:(id)value
{
    object.accounting = ((JpMasuidriveTiEvernoteapiEDAMAccountingProxy*)value).object;
}

...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMSharedNotebookProxy alloc] initWithObject: [[[EDAMSharedNotebook alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMSharedNotebookProxy
@synthesize object;

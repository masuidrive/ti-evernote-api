...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMNoteFilterProxy alloc] initWithObject: [[[EDAMNoteFilter alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMNoteFilterProxy
@synthesize object;

...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMPublicUserInfoProxy alloc] initWithObject: [[[EDAMPublicUserInfo alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMPublicUserInfoProxy
@synthesize object;

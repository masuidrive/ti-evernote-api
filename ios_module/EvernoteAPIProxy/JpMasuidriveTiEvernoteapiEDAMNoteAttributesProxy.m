...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMNoteAttributesProxy alloc] initWithObject: [[[EDAMNoteAttributes alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMNoteAttributesProxy
@synthesize object;

...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMDataProxy alloc] initWithObject: [[[EDAMData alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMDataProxy
@synthesize object;

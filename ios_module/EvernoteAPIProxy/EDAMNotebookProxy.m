...
-(id)createNotebook:(id)args
{
    return [[[EDAMNotebookProxy alloc] initWithObject: [[[EDAMNotebook alloc] init] autorelease]] autorelease];
}
@end


@implementation EDAMNotebookProxy
@synthesize object;
...
-(id)publishing
{
    return [[[EDAMPublishingProxy alloc] initWithObject: object.publishing] autorelease];
}

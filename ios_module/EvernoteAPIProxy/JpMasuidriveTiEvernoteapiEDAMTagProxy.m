...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMTagProxy alloc] initWithObject: [[[EDAMTag alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMTagProxy
@synthesize object;

...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMUserAttributesProxy alloc] initWithObject: [[[EDAMUserAttributes alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMUserAttributesProxy
@synthesize object;

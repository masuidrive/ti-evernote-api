...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMAccountingProxy alloc] initWithObject: [[[EDAMAccounting alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMAccountingProxy
@synthesize object;

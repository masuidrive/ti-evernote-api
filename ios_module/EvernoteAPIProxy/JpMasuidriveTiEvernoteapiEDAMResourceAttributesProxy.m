...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMResourceAttributesProxy alloc] initWithObject: [[[EDAMResourceAttributes alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMResourceAttributesProxy
@synthesize object;

...
{
    return [[[JpMasuidriveTiEvernoteapiEDAMPublishingProxy alloc] initWithObject: [[[EDAMPublishing alloc] init] autorelease]] autorelease];
}
@end


@implementation JpMasuidriveTiEvernoteapiEDAMPublishingProxy
@synthesize object;
